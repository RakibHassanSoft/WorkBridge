...
const AUDIENCES = [
  {
    ...
    points: {
      en: [
        "Affordable work without the usual quality anxiety — every task is coordinator-checked",
        "Sign up in a minute: an account and a payment method, no trade licence or company papers",
      ...
      bn: [
        "সাশ্রয়ী কাজ, কিন্তু কোয়ালিটি নিয়ে চেনা দুশ্চিন্তা ছাড়াই — প্রতিটি টাস্ক কোঅর্ডিনেটর-যাচাইকৃত",
        "এক মিনিটে শুরু: একটা অ্যাকাউন্ট আর পেমেন্ট মেথড — ট্রেড লাইসেন্স বা কোম্পানির কাগজ নয়",
  ...
  {
    icon: UserCog,
    who: { en: "For universities & training bodies", bn: "বিশ্ববিদ্যালয় ও প্রশিক্ষণ প্রতিষ্ঠানের জন্য" },
    line: { en: "Placement figures nobody can dispute.", bn: "এমন প্লেসমেন্ট সংখ্যা, যা কেউ প্রশ্ন করতে পারবে না।" },
    body: {
      en: "Departments are judged on employment outcomes they cannot evidence. A student's verified record is external, signed by a paying business, and impossible for the institution to inflate — which is exactly what makes it worth citing.",
      bn: "বিভাগগুলোকে বিচার করা হয় এমন কর্মসংস্থানের ফল দিয়ে, যার প্রমাণ তাদের হাতে নেই। শিক্ষার্থীর ভেরিফায়েড রেকর্ড বাইরের, টাকা দেওয়া ব্যবসার স্বাক্ষরিত, আর প্রতিষ্ঠান চাইলেও বাড়িয়ে দেখাতে পারে না — এজন্যই এটি উদ্ধৃত করার মতো।",
    },
    points: {
      en: [
        "Real paid work counted towards internship and project credit",
        "Evidence of employability that came from outside the institution",
        "A pipeline for the departments nobody recruits from — not just CSE",
        "No new system to run: students sign up themselves",
      ],
      bn: [
        "ইন্টার্নশিপ ও প্রজেক্ট ক্রেডিটে গণনাযোগ্য বাস্তব পেইড কাজ",
        "প্রতিষ্ঠানের বাইরে থেকে আসা কর্মদক্ষতার প্রমাণ",
        "যেসব বিভাগ থেকে কেউ নিয়োগ দেয় না তাদের জন্যও পাইপলাইন — শুধু সিএসই নয়",
        "নতুন কোনো সিস্টেম চালাতে হবে না: শিক্ষার্থীরা নিজেরাই যুক্ত হন",
      ],
    },
  },
];
